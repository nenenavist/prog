...
public class CollectionManager {
    ...
    public CollectionManager(String arg) {
        ...
        try {
            ...
            System.out.println("Autoloading completed");
        } catch (Exception e) {
     ...
     *
     * @param args The command arguments containing the file path.
     */
    public static void save(){
        XMLSerializer stream = new XMLSerializer();
        String xml = stream.serialize(collection);
        try {
            BufferedOutputStream output = new BufferedOutputStream(new FileOutputStream("lab.xml"));
